...
const Banner = () => {
    ...
    return (
        <div>
            <div className='grid grid-cols-11 p-20 bg-gradient-to-t from-[#a6bdfe] z-0'>
                <div className='col-span-4'>
                    <h1 className='md:text-[20px] lg:text-[50px] font-bold space-y-2 dark:text-white'>
                    ...
                    <p className='text-[#6b7389] dark:text-white text-lg mt-7 mb-5'>Search for your contest and participate now to win fantastic prizes. Don&apos;t miss your chance to become a winner!</p>
                            ...
                            <div className="relative">
                                <span className="absolute inset-y-0 left-0 flex items-center pl-2">
                                    <button type="button" title="search" className="p-1 hover:w-[24px] duration-200">
                                        <svg fill="currentColor" viewBox="0 0 512 512" className="w-4 h-4 dark:text-gray-100 text-gray-800 md:ml-24 hover:text-blue-700 duration-200">
            ...
            <div className='-mt-[100px] w-full h-40 bg-white dark:bg-[#2a303c] rounded-t-[100%] z-10 relative'>
