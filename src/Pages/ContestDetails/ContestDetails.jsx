        ...
        <div className="relative">
            <div className="flex flex-col lg:flex-row bg-gradient-to-t from-[#3158efa1] text-black p-0 md:p-9">
                <div className="m-5 md:m-20 mt-32">
                    {
                        Object.keys(ContestWinner).length > 0? <div className="badge  badge-accent">Contest Over</div>:
                    ...
                    <div className=" flex gap-16 mb-4">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <div className="badge badge-secondary badge-sm">{Applied.length > 0 ? Applied.length : 0}</div>
                        </div>
                    </div>
                    <div className="mb-10">
            ...
            <div className="w-[380px] relative lg:absolute md:bottom-64 lg:bottom-20 md:-right-[370px] lg:right-20">
                <div className="block rounded-xl bg-white shadow-xl dark:bg-neutral-700 text-center">
                    ...
                    <div className="p-6">
                        ...
                        {
                            Object.keys(ContestWinner).length > 0 ? <p>The Winner of this Contest is <samp className="font-bold">{ContestWinner.apply.Name}</samp></p> :
                                <>
                                    {
                                        !toggle ?
