        ...
        <div>
            ...
            <div className="w-full max-w-md p-4 rounded-md shadow sm:p-8 dark:bg-gray-900 bg-gray-50 dark:text-gray-100 text-gray-800">
                ...
                <div className="my-6 space-y-4">
                    <ButtonOutline aria-label="Login with Google" type="button" text="Login with Google" icon={<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className=" w-5 h-5 fill-current">
                    ...
                    <ButtonOutline aria-label="Login with Google" type="button" text="Login with GitHub" icon={<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="w-5 h-5 fill-current">
